...
<meta http-equiv="description" content="添加课程" />
<title>添加课程</title>
    ...
    <div class="row">
      ...
      <div class="col-lg-10">
        <form class="form-horizontal"
          action="<%=request.getContextPath()%>/course/add"
          method="POST">

          <div class="form-group">
            <label for="number" class="col-lg-2 control-label">课程号</label>
            <div class="col-lg-6">
              <input class="form-control" name="number"
                value="${course.number}" />
            </div>
            <div class="col-lg-4">
              <p class="text-danger">请输入课程号</p>
            </div>
          </div>
